...
export const envValidationSchema = Joi.object({
  ...
  APP_NAME: Joi.string().default('NestJS Basic Auth'),
  ...
  HEALTH_DISK_THRESHOLD_PERCENT: Joi.number().min(0).max(100).required(),
  HEALTH_MEMORY_RSS_LIMIT_MB: Joi.number().positive().required(),
